# External validation PCA using the 9-gene panel
#
# This script:
...
# - Extracts expression of the 9-gene polyglutamylation panel
...
#
# Output:
# - 9-gene PCA plot for all four datasets (.pdf, .png)
#
# Notes:
...
# ============================================================
# Make 9-gene PCA plots
# ============================================================

p_brca_9 <- make_pca_plot(
  expr_mat = expr_brca,
  metadata = meta_brca,
  genes = panel_9,
  dataset_name = "BRCA-9"
...
p_pca_9 <- (
  p_brca_9 | p_lung_9 | p_kidney_9 | p_crc_9
) +
  plot_annotation(
    title = "PCA of external validation datasets using the 9-gene panel",
    theme = theme(
